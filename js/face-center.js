...
const getUserAll = new Promise(function(resolve, reject) {
  // llamar a un api
  setTimeout(function() {
    // luego de 3 segundos
    resolve('se acabó el tiempo');
  }, 5000)
})
...
/* 
// ASI ERA EN EL ASQUEROSO JQUERY
...
(async function load() {
  ...
  // const { data: { movies9: actionList} } = await getData(`${BASE_API}list_movies.json?genre=action`)
